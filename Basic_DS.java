...
public class Test_Big5DataStructures extends junit.framework.TestCase {
	...
	public void testLinkedList() {
		...
		for( int i = 0; i < 20; i++ ) { // Very cheap here
			linkedList.add( String.format( "%s", i ) );
		}
	...
	public void testArrayList() {
		...
		for( int i = 0; i < 20; i++ ) {
			al.add( String.format("%s", i ) ); // Very expensive when re-allocating
		}
